...
const baseUrl = (): any => "https://159d5e59cf0c.ngrok.app";//process.env.REACT_APP_BASE_URL;
const paymentUrl= (): any => "https://d4188ff684a5.ngrok.app";//process.env.REACT_APP_BASE_URL;
