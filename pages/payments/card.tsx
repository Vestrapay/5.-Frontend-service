    ...
    return (
        <>
            <DashboardLayout>
                ...
                <main className="relative flex flex-1 flex-col px-8 pb-4 h-[90vh] w-full overflow-x-visible transition-all duration-300 ease-in-out px-10 sm:px-8 pb-10 h-full">
                    <nav>
