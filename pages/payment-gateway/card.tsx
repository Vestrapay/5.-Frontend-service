                    ...
                    <>
                        <div className="w-full h-6 justify-center items-center inline-flex">
                            <p className="text-center text-neutral-600 text-lg font-normal font-['Roboto'] leading-normal py-12">
                                Enter your phone number to enroll for online payment.</p>
                        </div>
                        <form className="flex flex-wrap gap-3 w-full xl:px-14">
                            ...
                            <div className="flex flex-wrap gap-10 w-full xl:px-14">
                                <label className="relative w-full flex flex-col">
                                    <span className="text-gray-400 text-sm font-bold font-['Roboto'] uppercase leading-3 mb-3">Address</span>
                                    <input
                                        ...
                                        value={stateValues?.cardPhoneOTP}
                                        required
                                    />
                ...
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z" />
                            ...
                            <div className="w-full flex flex-row justify-center items-center">
                                <DefaultButton
                                    ...
                                    handleClick={() => handleCardPayAuth("authPhone")}
                                // isDisabled={stateValues?.isDisabled}
                                />
                                <DefaultButton
                                    type="secondary"
                                    labelText={"Cancel"}
                                    containerVariant="w-max p-3 my-5 text-center text-lg font-extrabold font-['Roboto'] leading-tight"
                                    variant="w-full p-3 text-center text-lg font-extrabold font-['Roboto'] leading-tight"
                                    handleClick={() => handleExtraChange("cardStatus", "pay")}
                                // isDisabled={stateValues?.isDisabled}
                                />
                            </div>
            ...
            return (
                <PaymentGatewayLayout>
                    <>
                        <div className="w-full h-6 justify-center items-center inline-flex">
                            <p className="text-center text-neutral-600 text-lg font-normal font-['Roboto'] leading-normal py-12">
                                Enter your address details for verification</p>
                        </div>
                        <form className="flex flex-wrap gap-3 w-full xl:px-14">
                            <LoginErrorCard handleClear={handleClearError} error={stateValues?.errorMssg || ""} containerVariant={!stateValues?.submittingError ? "hidden" : "mx-14"} />
                            <div className="flex flex-wrap gap-10 w-full xl:px-14">
                                <label className="relative w-full flex flex-col">
                                    ...
                                    <input
                                        ...
                                        minLength={8}
                                        onChange={handleChange}
                                        value={stateValues?.cardAvsAddress}
                                        required
                                    />
                ...
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z" />
                                ...
                                <label className="relative flex-1 w-full flex flex-col">
                                    <span className="text-gray-400 text-sm font-bold font-['Roboto'] uppercase leading-3 mb-3">City</span>
                                ...
                                <label className="relative flex-1 w-full flex flex-col">
                                    <span className="text-gray-400 text-sm font-bold font-['Roboto'] uppercase leading-3 mb-3">state</span>
                                    <input className="rounded-none peer pl-12 pr-2 py-2.5 border-t-0 border-l-0 border-r-0 border-b border-slate-300 placeholder-gray-300"
                                        type="tel"
                                        onChange={handleChange}
                                        value={stateValues?.cardAvsState}
                                        required
                                        name="cardAvsState"
                                ...
                                <label className="relative flex-1 w-full flex flex-col">
                                    <span className="text-gray-400 text-sm font-bold font-['Roboto'] uppercase leading-3 mb-3">country</span>
                                    <input className="rounded-none peer pl-12 pr-2 py-2.5 border-t-0 border-l-0 border-r-0 border-b border-slate-300 placeholder-gray-300"
                                        type="tel"
                                        onChange={handleChange}
                                        value={stateValues?.cardAvsCountry}
                                        required
                                        name="cardAvsCountry"
                                ...
                                <label className="relative flex-1 w-full flex flex-col">
                                    <span className="text-gray-400 text-sm font-bold font-['Roboto'] uppercase leading-3 mb-3">zip code</span>
                                    <input className="rounded-none peer pl-12 pr-2 py-2.5 border-t-0 border-l-0 border-r-0 border-b border-slate-300 placeholder-gray-300"
                                        type="tel"
                                        onChange={handleChange}
                                        value={stateValues?.cardAvsZipCode}
                                        required
                                        name="cardAvsZipCode"
                            ...
                            <div className="w-full flex flex-row justify-center items-center">
                                <DefaultButton
                                    ...
                                    variant="w-full p-3 text-center text-neutral-50 text-lg font-extrabold font-['Roboto'] leading-tight"
                                    isLoading={stateValues?.isSubmitting}
                                    handleClick={() => handleCardPayAuth("authAvs")}
                                // isDisabled={stateValues?.isDisabled}
                                />
                                <DefaultButton
                                    type="secondary"
            ...
            return (
                <PaymentGatewayLayout>
                    <>
                        ...
                        <form className="flex flex-wrap justify-center items-center  gap-3 w-full xl:px-14 py-5">
                            ...
                            <div className="w-full flex flex-row justify-center items-center">
                                <DefaultButton
                                    ...
                                    variant="w-full p-3 text-center text-neutral-50 text-lg font-extrabold font-['Roboto'] leading-tight"
                                    isLoading={stateValues?.isSubmitting}
                                    handleClick={() => handleCardPayAuth("authOtp")}
                                // isDisabled={stateValues?.isDisabled}
                                />
                                <DefaultButton
                                    type="secondary"
                ...
                <PaymentGatewayLayout>
                    <>
                        ...
                        <form className="flex flex-wrap justify-center items-center  gap-3 w-full p-14">
                            ...
                            <OtpInput value={otp} type="password" valueLength={4} onChange={(val: any) => { onChangeOTP(val); handleExtraChange("cardPin", val) }} />
                            ...
                            <div className="w-full flex flex-row justify-center items-center">
                                <DefaultButton
                                    ...
                                    variant="w-full p-3 text-center text-neutral-50 text-lg font-extrabold font-['Roboto'] leading-tight"
                                    isLoading={stateValues?.isSubmitting}
                                    handleClick={() => handleCardPayAuth("authPin")}
                                // isDisabled={stateValues?.isDisabled}
                                /><DefaultButton
                                    type="secondary"
                                    labelText={"Cancel"}
        ...
        default:
            return (
                ...
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z" />
                                ...
                                <label className="relative flex-1 w-full flex flex-col">
                                    <span className="text-gray-400 text-sm font-bold font-['Roboto'] uppercase leading-3 mb-3">Customer Email</span>
                                    <input className="rounded-none peer pl-12 pr-2 py-2.5 border-t-0 border-l-0 border-r-0 border-b border-slate-300 placeholder-gray-300"
                                           type="email"
                                           onChange={handleChange}
                                           value={stateValues?.cardEmail}
                                           required
                                           name="cardEmail"
