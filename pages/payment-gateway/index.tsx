...
import { payWithCardController } from "containers/paymentGatewayApi";


const PaymentGateway: NextPage = () => {

    const { handleSubmit, handleClearError, handleChange, handleExtraChange, stateValues } = payWithCardController()
    ...
    return (
        <div className="relative bg-white w-[100%] h-[100%] overflow-hidden flex flex-row items-start justify-start gap-[172px] text-left text-[12.98px] text-darkslateblue font-roboto">
            ...
            <div className="self-stretch flex-3 relative w-4/5 h-[100%] px-40 py-20">
            ...
            <div className="w-2/5 h-full min-h-[100vh] relative bg-indigo-900 bg-opacity-10 flex flex-col justify-center gap-0 items-start">
                ...
                <div className="w-5/6 h-max px-20 pt-7 pb-6 bg-white rounded-tr-lg rounded-br-lg justify-start items-center gap-6 inline-flex">
                    <div className=" justify-center items-start flex">
                        <div className="w-10 h-10 relative bg-indigo-900 rounded-full flex justify-center items-center ">
                            <HiCreditCard size={15} color={"white"} />
                        </div>
                    </div>
                    <div className="px-px pb-px justify-center items-start flex">
                        <div className="text-center text-indigo-900 text-xl font-semibold font-['Inter'] leading-relaxed">Card</div>
                    </div>
                </div>

                <div className="w-5/6 h-max px-20 pt-7 pb-6 bg-none rounded-tr-lg rounded-br-lg justify-start items-center gap-6 inline-flex">
                    <div className=" justify-center items-start flex">
                        <div className="w-10 h-10 relative bg-gray-300 bg-opacity-[0.5] rounded-full flex justify-center items-center ">
                            <HiMiniHashtag size={20} color={"gray"} />
                        </div>
                    </div>
                    <div className="px-px pb-px justify-center items-start flex">
                        <div className="text-center text-gray-400 text-xl font-semibold font-['Inter'] leading-relaxed">USSD</div>
                    </div>
                </div>
                ...
                <div className="w-5/6 h-max px-20 pt-7 pb-6 bg-none rounded-tr-lg rounded-br-lg justify-start items-center gap-6 inline-flex">
                    <div className=" justify-center items-start flex">
                        <div className="w-10 h-10 relative bg-gray-300 bg-opacity-[0.5] rounded-full flex justify-center items-center ">
                            <HiBuildingLibrary size={20} color={"gray"} />
                        </div>
                    </div>
                    <div className="px-px pb-px justify-center items-start flex">
                        <div className="text-center text-gray-400 text-xl font-semibold font-['Inter'] leading-relaxed">Bank Transfer</div>
                    </div>
                </div>
                ...
                <div className="w-5/6 h-max px-20 pt-7 pb-6 bg-none rounded-tr-lg rounded-br-lg justify-start items-center gap-6 inline-flex">
                    <div className=" justify-center items-start flex">
                        <div className="w-10 h-10 relative bg-gray-300 bg-opacity-[0.5] rounded-full flex justify-center items-center ">
                            <HiMiniLink size={20} color={"gray"} />
                        </div>
                    </div>
                    <div className="px-px pb-px justify-center items-start flex">
                        <div className="text-center text-gray-400 text-xl font-semibold font-['Inter'] leading-relaxed">Payment Link</div>
                    </div>
                </div>
            </div>
        </div>
