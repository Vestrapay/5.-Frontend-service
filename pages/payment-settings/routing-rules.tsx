...
import { RoutingRulesController } from 'containers/routingRulesApi';
import UpdateRoutingRule from '@/components/payment/updateRoutingRule';
import CreateRoutingRule from '@/components/payment/createRoutingRule';
...
const RoutingRules = () => {
    ...
    const { isLoading, isError, error, isSuccess, data, refetch } = RoutingRulesController("")
        ...
        <>
            <DashboardLayout>
                <main
                    ...
                    <AdminPaymentNavBar name={"Routing Rule"} func={() => setShowCreate(!showCreate)} />
                    <DataGrid
                        initialState={{
                            columns: {
