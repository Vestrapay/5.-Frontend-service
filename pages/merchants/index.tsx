...
import { MerchantUsersController } from 'containers/merchantUserApi';
...
const Merchants = () => {
    ...
    const { isLoading, isError, error, isSuccess, data, refetch } = MerchantUsersController(showDelete, isEditUser, isCreateUser)
                ...
                return (<PoperDropDown
                    ...
                    options={
                        ([
                            ...
                            (<div key={2}
                                className={`h-10 flex items-center text-center gap-2 rounded-md cursor-pointer min-w-max text-blue-600 bg-sky-100 hover:bg-sky-200 ${userTypeValue === "ADMIN" ? "hidden" : " my-2 p-2 px-4 py-4"}`}
                                onClick={() => {
                                    // Enable edit mode for the row
                            ...
                            (<div key={3}
                                className={`h-10 flex items-center text-center gap-2 rounded-md cursor-pointer min-w-max text-red-500 bg-red-100 hover:bg-red-200 ${userTypeValue === "ADMIN" ? "hidden" : " my-2 p-2 px-4 py-4 "}`}
                                onClick={() => {
                                    // Enable edit mode for the row
                                    console.log("Editing user with id: ", id) //TODO: Edit the user with this id
                                    setSelected(id)
                            ...
                            (<div key={4}
                                className={`h-10 flex items-center text-center gap-2 rounded-md cursor-pointer min-w-max text-gray-500 bg-gray-100 hover:bg-gray-200 ${userTypeValue === "ADMIN" ? " my-2 p-2 py-4 px-4 " : "hidden"}`}
                                onClick={() => {
                                    // Enable edit mode for the row
                                    console.log("Editing user with id: ", id) //TODO: Edit the user with this id
                                    setSelected(id)
