...
import { enableAdminController } from "containers/usersApi";
...
export default function EnableAdmin({
    ...
    const { stateValues, handleSubmit, handleClearError } = enableAdminController(data)
                    ...
                    <div className=" flex flex-col my-5 w-full justify-center items-center">
                        ...
                        <div className="my-3 flex flex-col gap-5">
                            <p className=" w-full text-2xl font-700 text-center">
                                {data?.enabled ? "Disable Admin" : "Enable Admin"}
                            </p>
                            <p className="text-gray-900 w-full text-base font-300 leading-7 mt-3 text-center">
                                {data?.enabled ? "Are you sure you want to disable this admin user?" : "Are you sure you want to enable this admin user?"}
                            </p>
                        </div>
