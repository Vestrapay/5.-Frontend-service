...
const AtmCard = ({debitCardNumber="5789546256772847", cardHolder="Omonigho Isaiah", expiryDate="06/26", cardProvider = ""}) => {
    ...
    return (
        <div className="flex relative w-[321px] h-[196px] bg-selected rounded-xl flex-col p-5 drop-shadow-md">
