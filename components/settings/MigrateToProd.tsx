...
import { migrateToProductionController } from "containers/usersApi";
import { LoginErrorCard } from "@utils/actions/error";

export default function MigrateToProd({ show, setShow }: any) {

    const { stateValues, handleSubmit, handleClearError } = migrateToProductionController()
                    ...
                    <div className=" flex flex-col my-5 w-full justify-center items-center">
                        ...
                        <div className="my-3 flex flex-col gap-5">
                            ...
                            <p className="text-gray-900 w-full text-base font-300 leading-7 mt-3 text-center">
                                Are you sure you want to move to the production instance?
                            </p>
                        </div>
