...
function UpdateIndentification({ show, showModal }: any) {

    return (
        <div>
            <Modal show={show} clicked={showModal}>
                <div className=' flex justify-center'>
                    <div className="w-full py-8 pl-4 pr-12 max-w-[500px] h-2/3 flex flex-col items-center justify-center ">
                        ...
                        <div className="flex flex-row justify-start gap-8 w-full h-full bg-primary-white rounded-xl backdrop-blur-sm ">
                            ...
                            <div className=" w-full h-full flex flex-col justify-between gap-24">
                                <div className="flex flex-col items-center gap-8">
                                    <div>
                                        <p className=' w-fit text-xl font-600 '>Means of Identification</p>
                                        <p className='text-gray-400  w-fit text-base font-400 leading-7 mt-3'>Please, upload a govrnment issued Identity document</p>
                                    </div>
...
export default UpdateIndentification