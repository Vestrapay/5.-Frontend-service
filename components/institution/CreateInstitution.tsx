...
import { fetchAllBanksData } from 'containers/settingsApi'
import { createController } from 'containers/institutionApi'
import Switch from "react-switch";


export default function CreateInstitution({ show, showModal }: any) {
    ...
    const {
        ...
        settlementBank,
        isSnS,
        notificationUrl, errorMssg, isSubmitting, submittingError } = state
        ...
        <Modal show={show} clicked={() => { showModal(); setSelect(null) }}>
            <div className='m-3 flex flex-row gap-3 -ml-3 sm:ml-3'>
                <div className="flex gap-5">
                    ...
                    <div>
                        <p className=' w-fit text-2xl font-700 text-gray-200'>Create New Institution</p>
                        <p className='text-gray-400 w-fit text-base font-300 leading-7 mt-3'>Enter details below to create a new institution</p>
                    </div>
                </div>
            </div>
            ...
            <div className='flex flex-row gap-8 justify-around items-start md:max-w-[50vw] mb-10'>
                <div className=' w-3/4 relative'>
                    ...
                    <DefaultInput
                        ...
                        label={"Enter Notification Url"}
                        topLabel={"Notification Url"}
                        handleChange={handleChange}
                    ...
                    <div className="flex flex-col sm:flex-row gap-x-2" >
                        ...
                        <div className="flex items-center w-full gap-5 space-x-4 my-5">
                            <p className='text-gray-200'>SNS</p>

                            <Switch
                                onChange={(checked: any) => { setState({ ...state, isSnS: checked }) }}
                                checked={isSnS}
                                checkedIcon={true}
                                offColor="#3b4762"
                                onColor="#2362D7"
