    ...
    return (
        <div className="relative bg-white w-[100%] h-[100%] overflow-hidden flex flex-row items-start justify-around gap-[172px] text-left text-[12.98px] text-darkslateblue font-roboto">
            ...
            <div className="hidden md:flex w-[30%] h-[100%] min-h-[100vh] bg-indigo-900 bg-opacity-10  flex-col justify-center gap-0 items-start fixed right-0">
                ...
                <div className={` ${payType == "ussd" ? "bg-white" : "bg-none"} w-5/6 h-max px-5 lg:pl-10 xl:pl-20 lg:pr-5 pt-7 pb-6 rounded-tr-lg rounded-br-lg justify-start items-center gap-6 inline-flex cursor-pointer`} onClick={() => changePaymentType("/payment-gateway/ussd")}>
                    <div className=" justify-center items-start flex">
                ...
                <div className={` ${payType == "transfer" ? "bg-white" : "bg-none"} w-5/6 h-max px-5 lg:pl-10 xl:pl-20 lg:pr-5 pt-7 pb-6 rounded-tr-lg rounded-br-lg justify-start items-center gap-6 inline-flex cursor-pointer`} onClick={() => changePaymentType("/payment-gateway/transfer")}>
                    <div className=" justify-center items-start flex">
                ...
                <div className={` ${payType == "payment-link" ? "bg-white" : "bg-none"} w-5/6 h-max px-5 lg:pl-10 xl:pl-20 lg:pr-5 pt-7 pb-6 rounded-tr-lg rounded-br-lg justify-start items-center gap-6 inline-flex cursor-pointer`} onClick={() => changePaymentType("/payment-gateway/payment-link")}>
                    <div className=" justify-center items-start flex">
                    ...
                    <div className="px-px pb-px justify-center items-start flex">
                        <div className={`${payType !== "payment-link" ? "text-gray-400" : "text-indigo-900"} text-left xl:text-center text-xl font-semibold font-['Inter'] leading-relaxed`}>
                            Payment Link</div>
                    </div>
                </div>
            </div>
            ...
            >
                ...
                <div className=" z-[200] shadow-none flex w-[90%] sm:w-[55%] h-[100%] min-h-[100vh] bg-gray-100 flex-col justify-center gap-0 items-start fixed right-0 "> {/* hidden */}
