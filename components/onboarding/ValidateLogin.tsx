...
import { SignInController, VerifySignInController } from 'containers/onboardingApi';
...
const ValidateLogin = ({ setPage, passData, resetingPass, setResetingPass, signInStatus, setPassData }: any) => {
    ...
    } = SignInController(setPage, resetingPass, setResetingPass, signInStatus, passData, setPassData);
        ...
        <div className='w-2/3 flex flex-col items-center'>
            ...
            <p className='w-fit text-base font-500  my-10'>
                ...
                <span
                    ...
                    onClick={
                        key == 0.017 ?
                            () => { generateOtp(); setKey(Math.trunc(Math.random() * 10)) }
                            : () => null
                    }>
